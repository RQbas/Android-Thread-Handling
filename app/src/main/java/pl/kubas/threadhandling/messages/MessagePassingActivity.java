...
public class MessagePassingActivity extends AppCompatActivity {
    ...
    private void initThread() {
        ...
        this.looperThread = new LooperThread(progressBar, textView, uiThread); //Intiialization and start of worker thread
    ...
    private void initUIComponents() {
        actionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (looperThread.getmHandler() != null) { //Checking handler initialization
